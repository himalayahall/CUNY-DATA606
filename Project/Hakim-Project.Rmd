...
1. Individuals can only belong to one cell in the contingency table. That is, cells in the table are mutually exclusive – an individual cannot belong to more than one cell
...
This study identified the applicant's first name as a potential source of bias (!). It should raise awareness among the HR profession regarding subtle biases they have to be aware of and (hopefully) compensate against.  
