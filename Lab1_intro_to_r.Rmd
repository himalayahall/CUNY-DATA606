...
present <- present %>% 
    mutate(boy_ratio = boys / girls)
```

Arbuthnot's observation about boys being born in greater proportion than girls *does not* hold up in the U.S.
...
```{r present-find-year-of-max-births}
