...
The relationship is quadratic as shown by the upside down parabola. The margin of error is maximized at p = 0.5.
...
The sampling distribution of sample proportions at $n = 300$ and $p = 0.1$ is bimodal (has two peaks).
