...
There seems to be little to no relationship between `physical_3plus` and `weight`. I was not expecting there to be much relationship except, perhaps, at the extreme weight outliers since one can imagine outliers experiencing related health issues that might prevent them from exercising more often.

```{r}
boxplot(yrbss$weight ~ yrbss$physical_3plus, col="orange", main="Weight and Physical 3 Plus", ylab="Weight", xlab="Phy Active 3+ Days", horizontal = FALSE) 
```
...
>Ho: the average weight of those who exercise at least 3 times a week $=$ average weight of those who don't exercise at lesst 3 times a week
