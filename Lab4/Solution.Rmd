...
Step wise pattern might be due to large **jumps** in sodium content of items. Let's sort the sodium data to see if it is the case.  

We see large jumps from 1980 to 2607, from 26to to 3230, from 3370 to 3770, from 3770 to 4450, and from 4450 to 6080.
